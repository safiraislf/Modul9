            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?php echo e(route('profile')); ?>"><i class="bi bi-person-fill"></i> My
                                Profile</a></li>
                        <li>
...
<?php /**PATH C:\Users\ASUS\praktikum-laravel\praktikum-modul6\resources\views/layouts/nav.blade.php ENDPATH**/ ?>